		...
		<div class="container">
			<div class="jumbotron">
				...
				<?php
					...
					//perform SQL query
					$query = 'SELECT title, year_released, COUNT(*) FROM CONTENT, ALBUMS, REVIEWS WHERE CONTENT.contId = ALBUMS.contId AND CONTENT.contId = REVIEWS.contId GROUP BY CONTENT.contId ORDER BY title;';
