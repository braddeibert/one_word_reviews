			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="./pages/contributors.php">Actors</a>
						<a class="dropdown-item" href="./pages/contributors.php">Creators</a>
						<a class="dropdown-item" href="./pages/contributors.php">Directors</a>
						<a class="dropdown-item" href="./pages/contributors.php">Recording Artists</a>
						<a class="dropdown-item" href="./pages/contributors.php">Writers</a>
					</div>
				</li>
